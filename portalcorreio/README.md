# Portal Correio Scraper

Este é um script de web scraping para extrair as principais notícias do Portal Correio (portalcorreio.com.br).

## Funcionalidades
- Extrai títulos, links e imagens das notícias da página inicial
- Identifica padrões de URL únicos para evitar duplicações e capturar apenas artigos de notícias (ignorando páginas estáticas e de categorias)
