...
Este é um script de web scraping para extrair as principais notícias do portal Jornal da Paraíba.

## Funcionalidades
- Extrai títulos, links e imagens das notícias da página inicial
- Filtra links estruturais, redes sociais e categorias vazias
